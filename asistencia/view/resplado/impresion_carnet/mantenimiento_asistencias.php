<script src="../js/asistencias.js?rev=<?php echo time();?>"></script>
<div class="row">
  <div class="col-lg-12">
    <div class="ibox ibox-default">
      <div class="ibox-head">
        <h5  class="ibox-title">REGISTROS DE ASISTENCIAS</h3>
      ...
      <div class="ibox-body">
        <table id="tabla_asistencias"  class="table tabel-display table-nowrap">
          <thead>
            <tr>
              <th style="background-color:#7a04e0;color:#FFFFFF;text-align: center;">#</th>
              <th style="background-color:#7a04e0;color:#FFFFFF;text-align: center;">ALUMNO</th>
              <th style="background-color:#7a04e0;color:#FFFFFF;text-align: center;">DNI</th>
              <th style="background-color:#7a04e0;color:#FFFFFF;text-align: center;">FECHA</th>
              <th style="background-color:#7a04e0;color:#FFFFFF;text-align: center;">HORA</th>
              <th style="background-color:#7a04e0;color:#FFFFFF;text-align: center;">HORA 2</th>
              <th style="background-color:#7a04e0;color:#FFFFFF;text-align: center;">ID</th>
              <th style="background-color:#7a04e0;color:#FFFFFF;text-align: center;">Email</th>
            <th style="background-color:#7a04e0;color:#FFFFFF;text-align: center;text-align: center;width: 80px;word-wrap: break-word;">Acci&oacute;n</th>
            </tr>
          </thead>
          <tbody>
...
<div class="modal fade" id="modal_registro">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div style="background-color:#298a75;color:#FFFFFF;" class="modal-header">
