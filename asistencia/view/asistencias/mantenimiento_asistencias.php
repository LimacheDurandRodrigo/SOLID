        ...
        <table id="tabla_asistencias"  class="table tabel-display table-nowrap">
          <thead>
            <tr>
              ...
              <th style="background-color:#230254;color:#FFFFFF;text-align: center;">DNI</th>
              <th style="background-color:#230254;color:#FFFFFF;text-align: center;">FECHA</th>
              <th style="background-color:#230254;color:#FFFFFF;text-align: center;">HORA</th>
              <th style="background-color:#230254;color:#FFFFFF;text-align: center;">HORA 2</th>
              <th style="background-color:#230254;color:#FFFFFF;text-align: center;">ID</th>
              <th style="background-color:#230254;color:#FFFFFF;text-align: center;">ESTADO</th>
            <th style="background-color:#230254;color:#FFFFFF;text-align: center;">-</th>
            </tr>
          </thead>
          <tbody>
          ...
          <tfoot>
            ...
            <th>DNI</th>
              ...
              <th style="text-align: center;width: 80px;word-wrap: break-word;">-</th>
            </tr>
          </tfoot>
        </table>
      </div>
