    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
				...
				<div class="d-inline">
                    <h5>Mantenimiento Solicitud Ingreso</h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <nav class="breadcrumb-container" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Solicitud Ingreso</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header"  style="padding: 10px 20px;">
            	<table style="width: 100%;">
	                <tr>
	                  	<td style="width:70%">
	                    	<h3>Listado de Solicitudes de Ingreso</h3>
	                  	</td>
	                  	<td style="width:30%">
	                  	</td>
	                </tr>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-5 form-group">
                        ...
                        <input type="date" class="form-control" id="txt_finicio" disabeld>  
                    </div>
                    <div class="col-lg-5 form-group">
                        <label for="">Fecha Fin:</label>
                        <input type="date" class="form-control" id="txt_ffin" disabeld>  
                    </div>
                    <div class="col-lg-2 form-group">
                        <label for="">&nbsp;</label><br>
                        <button class="btn btn-md btn-warning" style="width:100%;" onclick="listar_ingreso_seguridad()"><i class="fa fa-search" ></i>&nbsp;<b>Buscar</b></button>
                    </div>
                </div>
            	<div class="col-12 table-responsive">
                    <table id="tabla_ingreso_seguridad" class="table compact" style="font-size:small;width: 102%">
                        <thead>
                            <tr>
                                <th style="text-align: center;width: 50px;">#</th>
                                <th style="text-align:center;width:80px">Fecha Ingreso</th>
                                <th style="text-align:center;width:80px">Procesado Por</th>
...
?>
    <script type="text/javascript">
        listar_ingreso_seguridad();
        $(document).ready(function(){
            setInterval('listar_ingreso_seguridad()',30000);
        });
    </script>
<?php 
    }
