...
<head>
    ...
    <title>Inicio de Sesi&oacute;n | Sistema Control Registros</title>
...
<body class="hold-transition login-page" style="background: url('img/fondo.jpg') no-repeat; background-size: cover;">
<br><br><br><br>


    <div class="content ">
        <div class="brand ancho">
            <a style="font-weight:bold; font-size:30px;" class="link" href="index.php">Sistema De Asistencias con Codigo QR</a>
        </div>


        <form id="login-form" style="background-color:#f5c105;" style="padding-bottom: 0px" class="card ancho" onsubmit="return false">
            ...
            <div class="form-group row" style="padding-bottom: 0px">
                ...
                <div class="col-md-12">
                    <div style="text-align: right !important;padding-bottom: 0px" >
                        <a href="LECTOR/index.php" style="font-weight: bold;color: #9B0000;">BuscarLector</a>
                    </div>
                </div>
