...
function listar_asistencias(){
    table = $("#tabla_asistencias").DataTable({
//Aca comienza para la Exportacion de los botones 
    ...
    //	"autoWidth": false,
        ...
        "ajax":{
            "method":"POST",
    		"url":"../controller/asistencias/controlador_asistencias_listar.php",
        },
        "columns":[
            {"defaultContent":""},
            {"data":"personal"},
...
//Aca comienza para la Exportacion de los botones 
        ...
        },
        {
          ...
          className: 'btn',
          pageSize: 'LEGAL',
          title: 'Listado del Asistencias',
          exportOptions: {
              columns: [0,1,2,3,4,5,7] //exportar solo la primera y segunda columna
          },
          extend: 'excelHtml5',
                  //title: tituloexcel,
          text: "Exportar&nbsp;&nbsp;<img src='img/excel.png'>",
          footer:true,
          sheetName:'Listado de Asistencias',
