...
<html>
   ...
   require_once('navbar.php');
    ...
    <body style="background:#eee">
       ...
       <div class="container">
            <div class="row">
                <div class="col-md-4" style="padding:10px;background:#f7e907;border-radius: 5px;" id="divvideo">
					...
					<br>
					Derechos Reservados Onesystemas S.A.C
					<br>
					<?php
                ...
                <div class="col-md-8">
                <form action="CheckInOut.php" method="post" class="form-horizontal" style="border-radius: 5px;padding:10px;background:#f2ef13;" id="divvideo">
                     <i class="glyphicon glyphicon-qrcode"></i> <label>CONTROL DE ENTRADA - SCAN QR CODE</label> <p id="time"></p>
				...
				<div style="border-radius: 5px;padding:10px;background:#fff;" id="divvideo">
                  <table id="example1" class="table table-bordered">
                    <thead style="background-color:#f2ef13;color:#0a0a0a;text-align: center;">
                        <tr>
						<td>PERSONAL</td>
						<td>CODID</td>
						<td>HORA</td>
                    ...
                    <tbody>
                       ...
                       require 'r_conexion.php';
                        ...
                        ?>
                            <tr style="background-color:#7a04e0;color:#FFFFFF;text-align: center;">
							
                                <td style="background-color:#7a04e0;color:#FFFFFF;text-align: center;"><?php echo $row['LASTNAME'].', '.$row['FIRSTNAME'].' '.$row['MNAME'];?></td>
