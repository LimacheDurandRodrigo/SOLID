...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center" style="background-color:#7a04e0;color:#FFFFFF;">
      <a href="#" class="h2">Administrador Login</a>
    </div>
    <div class="card-body">
      ...
      <p class="mb-0">
        <a href="../index.php" class="text-center">Administrador</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
