    ...
    <body style="background:#eee">
       ...
       <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                <form action="CheckInOut2.php" method="post" class="form-horizontal" style="border-radius: 5px;padding:10px;background:#67aef5;" id="divvideo">
                     <i class="glyphicon glyphicon-qrcode"></i> <label>CONTROL DE SALIDA - SCAN QR CODE</label> <p id="time"></p>
				...
				<div style="border-radius: 5px;padding:10px;background:#fff;" id="divvideo">
                  <table id="example1" class="table table-bordered">
                    <thead>
                        <tr style="background-color:#05095e;color:#FFFFFF;text-align: center;">
						<td>PERSONAL</td>
						<td>CODID</td>
						<td>HORA</td>
						<td>HORA 2</td>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr style="background-color:#030aa8;color:#FFFFFF;text-align: center;">
							<td style="background-color:#030aa8;color:#FFFFFF;text-align: center;"><?php echo $row['LASTNAME'].', '.$row['FIRSTNAME'].' '.$row['MNAME'];?></td>
